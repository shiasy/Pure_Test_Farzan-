...
function loadpage(url='',operator){
   ...
   $.ajax({
        ...
        beforeSend: function(){
              ...
              if (status=='') {
                $('[data-operator="'+operator+'"] tbody').html('<div id="'+idloadingpage+'" data-url="'+url+'" data-operator="'+operator+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='append') {
                $('[data-operator="'+operator+'"] tbody').append('<div id="'+idloadingpage+'" data-url="'+url+'" data-operator="'+operator+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='prepend') {
                $('[data-operator="'+operator+'"] tbody').prepend('<div id="'+idloadingpage+'" data-url="'+url+'" data-operator="'+operator+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }
            },
        url:url,
        dataType: 'html',
...
function popup(data,url,cls,status='',load='1'){
   ...
   $.ajax({
        ...
        beforeSend: function(){
          ...
          if (load==1) {
            if (status=='') {
              $(cls).html('<div id="'+idloadingpage2+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
            }else if (status=='append') {
              $(cls).append('<div id="'+idloadingpage2+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
            }else if (status=='prepend') {
              $(cls).prepend('<div id="'+idloadingpage2+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
            }            
          }
...
idloadingpage3='loading'+Math.floor((Math.random() * 1000000) + 1);
   ...
   $.ajax({
        ...
        beforeSend: function(){
              ...
              if (status=='') {
                $(cls).html('<div id="'+idloadingpage3+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='append') {
                $(cls).append('<div id="'+idloadingpage3+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='prepend') {
                $(cls).prepend('<div id="'+idloadingpage3+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }
...
idloadingpagesendform='loading'+Math.floor((Math.random() * 1000000) + 1);
    $.ajax({
        ...
        beforeSend: function(){
              ...
              if (status=='') {
                $(cls).html('<div id="'+idloadingpagesendform+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='append') {
                $(cls).append('<div id="'+idloadingpagesendform+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='prepend') {
                $(cls).prepend('<div id="'+idloadingpagesendform+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }
...
idloadingpage='loading'+Math.floor((Math.random() * 1000000) + 1);
    ...
    $.ajax({
        ...
        beforeSend: function(){
              ...
              if (status=='') {
                $(cls).html('<div id="'+idloadingpage+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='append') {
                $(cls).append('<div id="'+idloadingpage+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }else if (status=='prepend') {
                $(cls).prepend('<div id="'+idloadingpage+'" data-url="'+url+'" data-cls="'+cls+'" class="loadingpage"><img src="./includes/images/loading/1.gif"></div>');
              }
            },
        url:url,
        dataType: 'html',
