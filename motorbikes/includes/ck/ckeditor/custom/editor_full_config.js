...
CKEDITOR.editorConfig = function( config ) {
  ...
  config.height='300px'
  config.extraPlugins = "syntaxhighlight,codemirror,eqneditor";
  ...
  config.toolbar = [
    ...
    { name: 'insert', items: [ 'Image','EqnEditor', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'syntaxhighlight', 'PageBreak', 'Iframe' ] },
    '/',
